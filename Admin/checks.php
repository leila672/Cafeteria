                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        ?>
                                    <tr class="<?= $user['id'] ?>">
                                        <td>
                                            <button class="btn btn-default btn-xs" data-bs-toggle="collapse" data-bs-target="<?php echo "#demouser" . $user['user_id'] ?>">
                                                <span>+</span>
                                            </button>
                                        </td>
                                    ...
                                    <tr class="<?= $user['user_id'] ?>">
                                        <td colspan="5" class="hiddenRow">
                                            <div class="collapse" id="<?php echo "demouser" . $user['user_id'] ?>">
                                                <div class="container">
                                                    <div class="row">
                                                        <table class="table" style="width: 300px; margin-left:50px ; border : 2px solid white" >
                                                            ...
                                                            <tbody style="background-color: #f7e2d0;">
                                                                <?php
                                                                $orders = $db->userorders($user['user_id']);

                                                                foreach ($orders as $order) {
                                                                ?>
                                                                    <tr class="text-center">
                                                                        <td>
                                                                            <button class="btn btn-default btn-xs" data-bs-toggle="collapse" data-bs-target="<?php echo "#demoorder" . $order['user_id'] ?>" style="background-color:#9e7b5c;">
